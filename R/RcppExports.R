...
manual_registeration_matrix <- function(query_data, reference_landmark, query_landmark, width1, height1, width2, height2, method, nonrigid) {
    .Call('_VoltRon_manual_registeration_matrix', PACKAGE = 'VoltRon', query_data, reference_landmark, query_landmark, width1, height1, width2, height2, method, nonrigid)
}
