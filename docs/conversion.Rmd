...
We can use the zarr file directly in the **vrSpatialPlot** function to visualize the zarr array interactively in RStudio viewer. The **reduction** argument allows the umap of the Xenium data to be visualized alongside with the spatial coordinates of the Xenium cells.
