...
We use the **importSTOmics** function to import the STOmics readouts and create a VoltRon object. Here, we point to the folder an h5ad file generated using the **stereo.io.stereo_to_anndata** method of [stereopy](https://stereopy.readthedocs.io/en/latest/Tutorials/Format_Conversion.html). For more information, visit [https://stereopy.readthedocs.io/](https://stereopy.readthedocs.io/).
