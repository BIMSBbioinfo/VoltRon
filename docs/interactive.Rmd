...
We can convert the VoltRon object into an anndata object and save it as a a zarr array using the **as.AnnData** function which will create the array in the specified location.

```{r class.source="watch-out", eval = FALSE}
as.AnnData(xenium_data, file = "xenium_data.zarr", assay = "Xenium")
```
...
<img width="100%" height="100%" src="https://bimsbstatic.mdc-berlin.de/landthaler/VoltRon/Package/images/interactive_vitessce.png" class="center">
