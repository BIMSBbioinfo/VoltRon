...
<img width="70%" height="70%" src="https://bimsbstatic.mdc-berlin.de/landthaler/VoltRon/Package/images/molecule_visualize_celltype.png" class="center">
...
```{r eval = FALSE, class.source="watch-out"}
s2_summary <- Metadata(vr2_merged_acute1, assay = "Xenium_mol") %>%
