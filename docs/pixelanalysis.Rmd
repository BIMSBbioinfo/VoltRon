...
The VoltRon object stores the metadata information and localization of all tiles in the image.
...
Each row is associated with a tile of parsed from the image.
...
We can now reduce the dimensionality of these pixel intensities using PCA and visualize the data variability across tiles.
...
<img width="100%" height="100%" src="https://bimsbstatic.mdc-berlin.de/landthaler/VoltRon/Package/images/pixel_spatialcluster.png" class="center">
