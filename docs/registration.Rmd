...
library(rjson)
params <- rjson::fromJSON(file = "scalefactors_json.json")
...
To use B-spline based fine alignment, we need to install the SimpleITK package as below. 
...
In cases where at least one of the spatial omics datasets is missing its images, we can use the spatial
