...
The combined Visium and Xenium datasets in the shape of a VoltRon object can be used to transfer information across layers and assays. This is accomplished by aggregating and summarizing, for example, gene counts of cells from the Xenium assay aligned with each spots of Visium assay. 
