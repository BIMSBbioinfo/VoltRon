...
xen_reg <- registerSpatialData(object_list = list(Xen_seu_R1, Vis_seu, Xen_seu_R2), keypoints = keypoints)
```
...
xen_reg <- registerSpatialData(object_list = list(Xen_seu_R1, Vis_seu, Xen_seu_R2))
```
