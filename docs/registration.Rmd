...
We can now visualize both the original and aggregated counts of a gene, say TACSTD2, to validate the correlation of gene signatures across adjacent tissue sections, and to validate the accuracy of the automated image alignment.

```{r class.source="watch-out", eval = FALSE}
g1 <- vrSpatialFeaturePlot(VRBlock, assay = "Visium", features = "TACSTD2", 
                           crop = TRUE, norm = FALSE)
g2 <- vrSpatialFeaturePlot(VRBlock, assay = "Visium_pseudo", features = "TACSTD2", 
                           crop = TRUE, norm = FALSE)
g1 + g2
```
...
```{r class.source="watch-out", eval = FALSE}
vrSpatialFeaturePlot(VRBlock_new, features = c("KRT15_myoepithelial",
                                               "ACT2_myoepithelial"), 
                     crop = TRUE)
```
