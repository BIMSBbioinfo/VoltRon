...
For all layers with a GoeMx data, an additional assay within the same layer with **_decon** postfix will be created. 

```{r eval = FALSE, class.source="watch-out"}
GeoMxR1_merged <- getDeconvolution(GeoMxR1_merged, 
