...
In order to integrate the scRNA data and the GeoMx data sets within the VoltRon objects, we will use the [MuSiC](https://xuranw.github.io/MuSiC/articles/MuSiC.html) package. 

```{r eval = FALSE, class.source="watch-out"}
## Seurat Object
set.seed(1)
seu <- readRDS("../data/AnjaLung2023/GSE198864_lung_combined_all.rds")
