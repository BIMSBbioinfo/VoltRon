...
levels(clusters) <- c("DCIS_1", "DCIS_2", "IT_1", "ACTA2_myoepithelial", "IT_2", "IT_2",
                      "Macrophages", "Adipocytes", "CD8_TCells", "CD4_TCells", "KRT15_myoepithelial",
                      "EndothelialCells", "IT_4_LILRA4+", "StromalCells", "PLD4+_LILRA4+_CD4+_Cells", "MastCells", "MyelomaCells",
                      "BCells")
