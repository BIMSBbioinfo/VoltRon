...
Now we can visualize features both existing in the Xenium panel such as FASN, 
and compare it with another tumor marker, e.g. SQLE, that are spatially
correlated with FASN in this tissue section. 
...
g1 <- vrSpatialFeaturePlot(Xen_data, assay = "Assay1", 
                           features = "FASN", n.tile = 200)
vrMainFeatureType(Xen_data[["Assay1"]]) <- "RNA_import"
g2 <- vrSpatialFeaturePlot(Xen_data, assay = "Assay1", 
                           features = "SQLE", n.tile = 200)
g1 | g2
```
