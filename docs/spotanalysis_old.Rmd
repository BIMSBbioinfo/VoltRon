...
With **vrSpatialPlot** we can visualize subcellular components as well as cells with several identities. We visualize mRNAs of ACTA2, a marker for smooth muscle cell actin, and TCF7, an early exhausted t cell marker. We can select interactively subset of the tissue sections and visualize the localization of these transcripts.
