...
<tbody>
  <tr>
   ...
   <td> 
      ...
      <img width="270" height="250" src="https://bimsbstatic.mdc-berlin.de/landthaler/VoltRon/Package/images/conversion.png" class="center">
      <p style = "margin: 3%"> Converting VoltRon objects into Seurat, Giotto, squidpy (anndata) etc. <strong> (under development) </strong></p>
   </td>
  </tr>
</tbody>
</table>
